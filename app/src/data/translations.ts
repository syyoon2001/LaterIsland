...
export const translations = {
  ko: {
    ...
    formImageLabel: '이미지 (선택)',
    formImageSelect: '+ 이미지 선택',
    formImageRemove: '이미지 제거',
    ...
    delete: '삭제',
    restore: '복구',
    renameCategoryTitle: '카테고리 이름 수정',
    renameTagTitle: '태그 이름 수정',
    confirmDeleteSelectedTitle: (count: number) => `${count}개 항목을 완전히 삭제할까요?`,
    confirmDeleteSingleTitle: '이 항목을 삭제할까요?',
    confirmDeleteHint: '삭제한 항목은 설정 > 휴지통에서 확인할 수 있어요',
    // Split around the settings gear icon rendered inline by ConfirmDialog —
    // must stay consistent with confirmDeleteHint above.
    confirmDeleteHintBefore: '삭제한 항목은',
  ...
  en: {
    ...
    formImageLabel: 'Image (optional)',
    formImageSelect: '+ Select image',
    ...
    delete: 'Delete',
    restore: 'Restore',
    renameCategoryTitle: 'Edit Category Name',
    renameTagTitle: 'Edit Tag Name',
    confirmDeleteSelectedTitle: (count: number) => `Delete ${count} items permanently?`,
    confirmDeleteSingleTitle: 'Delete this item?',
    confirmDeleteHint: 'Deleted items can be found in Settings > Trash',
    confirmDeleteHintBefore: 'Deleted items can be found in',
